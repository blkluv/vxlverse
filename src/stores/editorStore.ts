...
const DEFAULT_SCENES = [
  {
    ...
    objects: [
        ...
        quests: [
          {
            ...
            dialogues: [
              ...
              },
              {
                ...
                choices: [
                  { text: 'I\'ll help investigate', nextDialogue: 2 },
                ]
              },
              {
                id: 2,
                ...
                choices: [
                  { text: 'I\'ll start looking', nextDialogue: null }
                ]
              }
            ],
            requirements: {
      ...
      },
      {
        id: 'house-2',
        name: 'Open House',
        modelUrl: 'https://raw.githubusercontent.com/mpoapostolis/3d-assets/refs/heads/master/storage/scene_ZOxj74x3At.glb',
        position: new THREE.Vector3(5, 0, -5),
        rotation: new THREE.Euler(0, -Math.PI / 4, 0),
        scale: new THREE.Vector3(1, 1, 1),
        quests: []
      },
      {
        id: 'bush-1',
        name: 'Garden Bush',
        modelUrl: 'https://raw.githubusercontent.com/mpoapostolis/3d-assets/refs/heads/master/storage/scene_4p3ub4DfTl.glb',
        ...
        quests: [
          {
            ...
            dialogues: [
              ...
              },
              {
                ...
                choices: [
                  { text: 'What do you need?', nextDialogue: 2 }
                ]
              },
              {
                id: 2,
                ...
                choices: [
                  { text: 'I\'ll gather them', nextDialogue: null }
                ]
              }
            ],
            requirements: {
    ...
    objects: [
      {
        id: 'tree-1',
        name: 'Mystical Tree',
        modelUrl: 'https://raw.githubusercontent.com/mpoapostolis/3d-assets/refs/heads/master/storage/scene_3pHhvPmrhE.glb',
        position: new THREE.Vector3(-3, 0, -3),
        rotation: new THREE.Euler(0, 0, 0),
      ...
      },
      {
        id: 'flower-patch',
        name: 'Magic Flowers',
        modelUrl: 'https://raw.githubusercontent.com/mpoapostolis/3d-assets/refs/heads/master/storage/scene_i135puuBOq.glb',
      ...
      },
      {
        ...
        modelUrl: 'https://raw.githubusercontent.com/mpoapostolis/3d-assets/refs/heads/master/storage/scene_zBz7cYcBcK.glb',
      ...
      },
      {
        ...
        modelUrl: 'https://raw.githubusercontent.com/mpoapostolis/3d-assets/refs/heads/master/storage/scene_FXCFR5mM0D.glb',
        position: new THREE.Vector3(0, 0, 0),
        rotation: new THREE.Euler(0, Math.PI, 0),
        scale: new THREE.Vector3(1, 1, 1),
        quests: [
          {
            ...
            description: 'Help the Forest Guardian restore balance to the forest.',
            dialogues: [
              {
                id: 0,
              ...
              },
              {
                ...
                choices: [
                  { text: 'How do I help?', nextDialogue: 2 }
                ]
              },
              {
                id: 2,
                ...
                choices: [
                  { text: 'I\'ll start gathering', nextDialogue: null }
                ]
              }
            ],
            requirements: {
  ...
  persist(
    subscribeWithSelector((set) => ({
      ...
      setShowModelSelector: (show) =>
        set({ showModelSelector: show }),

      setEditingSceneName: (id) =>
        set({ editingSceneName: id }),
