      ...
      <AnimatePresence>
        {rewards && (
          ...
          >
            ...
            <motion.div
              variants={notificationVariants}
              className="px-4 py-2 bg-gradient-to-r from-emerald-900/95 to-emerald-800/95 border-2 border-emerald-400 lg text-emerald-200 font-pixel text-sm shadow-xl flex items-center whitespace-nowrap relative overflow-hidden"
            >
              <motion.div
